...
<script type="text/javascript">
    ...
    $(function(){
       $.ajax({
           type:"post",
           url:"<c:url value="/menu/show.do"/>",
           dataType:"json",
           success:function(data){
               $.each(data, function (index, first) {
                   var c = "";
                   $.each(first.menuChilder, function (index2, second) {
                       c += " <p style='text-align: center'><a href='#' onclick= \" addTabs('" + second.name + "','" + second.href + "','" + second.iconCls + "')\" class='easyui-linkbutton' data-options=\"iconCls:'"+second.iconCls+"',width:'90%'\">" + second.name + "</a></p>";
                   })
